...
final class HealthConditionSeeder extends Seeder
{
    ...
    {
        $conditions = [
            // Metabolic / Blood Sugar Conditions (1-4)
            [
            ...
            // Hormonal / Endocrine Conditions (13-15)
            [
            ...
            // Musculoskeletal & Joint Conditions (16-17)
            [
                'name' => 'Osteoporosis',
                'order' => 16,
