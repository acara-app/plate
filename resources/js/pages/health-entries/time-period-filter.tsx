...
const getPeriods = (
    ...
    {
        value: '7d',
        label: t('health_entries.tracking_page.time_periods.7d'),
        icon: Calendar,
    },
    {
        value: '30d',
        label: t('health_entries.tracking_page.time_periods.30d'),
        icon: CalendarDays,
    },
    {
        value: '90d',
        label: t('health_entries.tracking_page.time_periods.90d'),
        icon: CalendarRange,
    },
];
