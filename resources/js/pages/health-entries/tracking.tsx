...
export default function DiabetesLogDashboard() {
    ...
    return (
        <AppLayout breadcrumbs={getBreadcrumbs(t)}>
            <Head title={t('health_entries.tracking_page.title')} />
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">
                                {t('health_entries.tracking_page.title')}
                            </h1>
                            <p className="text-muted-foreground">
                                {t('health_entries.tracking_page.description')}
                            </p>
                        </div>
                        <div className="flex gap-2">
                            ...
                            <Button onClick={createModal.open}>
                                ...
                                {t('health_entries.tracking_page.add_entry')}
                            </Button>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>
                                {t(
                                    'health_entries.tracking_page.time_period_title',
                                )}
                            </CardTitle>
                            <CardDescription>
                                {t(
                                    'health_entries.tracking_page.time_period_description',
                                )}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            ...
                            <CardContent className="py-16 text-center">
                                <div className="mx-auto max-w-md space-y-4">
                                    <h3 className="text-lg font-semibold">
                                        {t(
                                            'health_entries.tracking_page.no_entries_title',
                                        )}
                                    </h3>
                                    <p className="text-muted-foreground">
                                        {t(
                                            'health_entries.tracking_page.no_entries_description',
                                        )}
                                    </p>
                                    <Button onClick={() => createModal.open()}>
                                        <Plus className="mr-2 size-4" />
                                        {t(
                                            'health_entries.tracking_page.add_first_entry',
                                        )}
                                    </Button>
                                </div>
                            </CardContent>
                        ...
                        <>
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        {t(
                                            'health_entries.tracking_page.summary_tips_title',
                                        )}
                                    </CardTitle>
                                    <CardDescription>
                                        {t(
                                            'health_entries.tracking_page.summary_tips_description',
                                        )}
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-3 text-sm">
                                        <div className="flex justify-between border-b pb-2">
                                            <span className="text-muted-foreground">
                                                {t(
                                                    'health_entries.tracking_page.total_entries',
                                                )}
                                            </span>
                                        ...
                                        <div className="flex justify-between border-b pb-2">
                                            <span className="text-muted-foreground">
                                                {t(
                                                    'health_entries.tracking_page.time_period_label',
                                                )}
                                            </span>
                                            <span className="font-medium">
                                                {t(
                                                    `health_entries.tracking_page.time_periods.${timePeriod}`,
                                                )}
                                            </span>
                                        </div>
                                        <div className="flex justify-between border-b pb-2">
                                            <span className="text-muted-foreground">
                                                {t(
                                                    'health_entries.tracking_page.data_types_logged',
                                                )}
                                            </span>
                                            <span className="font-medium">
                                                {[
                                                    dataTypes.hasGlucose &&
                                                        t(
                                                            'health_entries.tracking_page.data_types.glucose',
                                                        ),
                                                    dataTypes.hasInsulin &&
                                                        t(
                                                            'health_entries.tracking_page.data_types.insulin',
                                                        ),
                                                    dataTypes.hasCarbs &&
                                                        t(
                                                            'health_entries.tracking_page.data_types.carbs',
                                                        ),
                                                    dataTypes.hasExercise &&
                                                        t(
                                                            'health_entries.tracking_page.data_types.exercise',
                                                        ),
                                                ]
                                                    .filter(Boolean)
                                                    .join(', ') ||
                                                    t(
                                                        'health_entries.tracking_page.data_types.none',
                                                    )}
                                            </span>
                                        </div>
                                        <div className="space-y-2 pt-2">
                                            <p
                                                ...
                                                dangerouslySetInnerHTML={{
                                                    __html: t(
                                                        'health_entries.tracking_page.tips.general',
                                                    ),
                                                }}
                                            />
                                            {dataTypes.hasGlucose &&
                                                ...
                                                !dataTypes.hasCarbs && (
                                                    <p
                                                        ...
                                                        dangerouslySetInnerHTML={{
                                                            __html: t(
                                                                'health_entries.tracking_page.tips.log_carbs_insulin',
                                                            ),
                                                        }}
                                                    />
                                                )}
                                            {!dataTypes.hasExercise && (
                                                <p
                                                    ...
                                                    dangerouslySetInnerHTML={{
                                                        __html: t(
                                                            'health_entries.tracking_page.tips.log_exercise',
                                                        ),
                                                    }}
                                                />
                                            )}
