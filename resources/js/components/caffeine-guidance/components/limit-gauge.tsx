    ...
    return (
        <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-none dark:border-slate-700 dark:bg-slate-800">
            <div className="flex items-start justify-between gap-4">
                ...
                <div className="rounded-full bg-gray-100 px-3 py-1 text-sm font-semibold text-gray-900 dark:bg-slate-700 dark:text-gray-50">
                    {props.value_label}
                </div>
            </div>
            <div
                className="mt-5 h-3 overflow-hidden rounded-full bg-gray-100 dark:bg-slate-700"
                role="meter"
