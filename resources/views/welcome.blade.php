    ...
    <div
        ...
        <div
            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse gap-0 lg:max-w-5xl lg:flex-row lg:gap-8">
                ...
                <div
                    class="relative mb-0 aspect-[4/3] w-full shrink-0 overflow-hidden rounded-t-2xl bg-gradient-to-br from-emerald-100 via-teal-50 to-cyan-100 shadow-2xl shadow-emerald-500/10 lg:mb-0 lg:aspect-auto lg:w-[480px] lg:rounded-2xl dark:from-emerald-950 dark:via-teal-950 dark:to-cyan-950 dark:shadow-emerald-500/5">
                    {{-- Decorative pattern --}}
                            ...
                            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform">
                                <div class="rounded-xl bg-white/95 p-4 shadow-2xl backdrop-blur-md lg:rounded-2xl lg:p-6 dark:bg-slate-800/95">
                                    <div class="text-center">
                                        <div class="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 text-white shadow-lg lg:mb-3 lg:h-16 lg:w-16">
