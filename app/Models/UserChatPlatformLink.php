...
final class UserChatPlatformLink extends Model
{
    ...
    public function generateToken(int $expiresInHours = 14): string
    {
    ...
    public function markAsLinked(User $user): void
    {
        $this->update([
            'user_id' => $user->id,
            'is_active' => true,
    ...
    {
        $query->whereNull('user_id')->whereNotNull('linking_token');
    }
}
